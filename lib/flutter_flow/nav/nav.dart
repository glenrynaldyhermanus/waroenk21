...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ActivityBrief',
          path: '/activityBrief',
          builder: (context, params) => ActivityBriefWidget(
            activity: params.getParam<ActivitiesRow>(
                'activity', ParamType.SupabaseRow),
          ),
        ),
        FFRoute(
          name: 'ActivityByGroup',
          path: '/activityByGroup',
          requireAuth: true,
          builder: (context, params) => ActivityByGroupWidget(
        ...
        FFRoute(
          name: 'RegisteredTeam',
          path: '/registeredTeam',
          builder: (context, params) => RegisteredTeamWidget(
            activity: params.getParam<ActivitiesRow>(
                'activity', ParamType.SupabaseRow),
          ),
        ),
        FFRoute(
          name: 'RegisteredTeamMember',
          path: '/registeredTeamMember',
          builder: (context, params) => RegisteredTeamMemberWidget(
