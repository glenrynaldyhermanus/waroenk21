...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF811D21);
  late Color secondary = const Color(0xFF9D635B);
  late Color tertiary = const Color(0xFFFCE8D4);
  late Color alternate = const Color(0xFFA8444E);
  late Color primaryText = const Color(0xFF342F2F);
  late Color secondaryText = const Color(0xFF736A6A);
  late Color primaryBackground = const Color(0xFFFDFBF9);
