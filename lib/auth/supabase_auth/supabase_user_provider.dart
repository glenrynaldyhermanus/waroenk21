...
class Waroenk21SupabaseUser extends BaseAuthUser {
  Waroenk21SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> waroenk21SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Waroenk21SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
